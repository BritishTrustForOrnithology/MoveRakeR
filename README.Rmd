...
`MoveRakeR` was borne out of seabird tracking work. Much of the focus of `MoveRakeR` is on movements of tracked animals from a central place, used within numerous papers to date (e.g. Thaxter et al. 2015, Langley et al. 2021, Clewley et al. 2023, Thaxter et al. 2025, O'Hanlon et al. 2025). The `MoveRakeR` pipeline requires a dataset with the following columns: *TagID*, *DateTime*, *latitude* and *longitude*. The `MoveRakeR` process is built around a `Track` class object. This is not a strict requirement but aids in visualisation of printing, plotting and summarising.
